...
<div class="mb-6 flex items-center gap-2 text-xs uppercase tracking-wide">
    ...
    >Alle</a>
    <a
        href="{{ route($route, array_filter(['range' => $range, 'area' => 'business'])) }}"
    ...
    >Business</a>
    <a
        href="{{ route($route, array_filter(['range' => $range, 'area' => 'private'])) }}"
